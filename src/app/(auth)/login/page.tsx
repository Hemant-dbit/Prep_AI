  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.success(" Login successful! Welcome back!", { id: "login-progress" });
        router.push("/home/dashboard");
      } else {
        toast.error(data.message || " Login failed. Please try again.", { id: "login-progress" });
        setErrorMessage(data.message || "Login failed. Please try again.");
      }
    } catch {
      toast.error("❌ Network error. Please check your connection and try again.", { id: "login-progress" });
